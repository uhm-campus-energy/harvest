...
| [harvest_kwh.ipynb](harvest_kwh.ipynb)                                   | Remove spikes and interpolate 15-minute kWh | CSV generated from harvest_orig                               | `harvest_kwh_…csv` (all rows) and `harvest_kwh_15min_…csv` (clock times only) |
| [harvest_kw.ipynb](harvest_kw.ipynb)                                     | Average power to 15-minute kW               | CSV generated from harvest_orig and `harvest_meter_guide.csv` | `harvest_kw_YYMMDD-YYMMDD.csv`                                                |
